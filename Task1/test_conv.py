...
class ConvTests(unittest.TestCase):
    ...
    def debug_test():
        conv = kernel_size_stub_constructor(kernel_size=(3, 3))
        ...
        print("Shapes match:", output.shape == test_output.shape)
        print("Values match:", torch.allclose(output, test_output, atol=1e-3))
